    ...
    public class NMEAParser
    {
        ...
        public bool ParseGPRMC(string sentence)
        {
            ...
            if (Words[1] != "")
            {
                ...
                if (Words[1].Length > 7)
                {
                    UtcMilliseconds = Convert.ToInt32(((float)double.Parse(Words[1].Substring(6)) * 1000).ToString());
                }
            ...
            if (Words[7] != "")
            {
                ...
                double Speed = double.Parse(Words[7]) * MPHPerKnot;
            ...
            if (Words[8] != "")
            {
                ...
                double Bearing = double.Parse(Words[8]);
        ...
        public bool ParseGPGSA(string sentence)
        {
            ...
            if (Words[15] != "")
            {
                if (PDOPReceived != null)
                    PDOPReceived(double.Parse(Words[15]));
            }
            if (Words[16] != "")
            {
                if (HDOPReceived != null)
                    HDOPReceived(double.Parse(Words[16]));
            }
            if (Words[17] != "")
            {
                if (VDOPReceived != null)
                    VDOPReceived(double.Parse(Words[17]));
            }
            return true;
        }
        ...
        public bool IsValid(string sentence)
        {
            ...
            //string left = sentence.Substring(sentence.IndexOf("*") + 1);
            //string right = GetChecksum(sentence);
            //return left == right;    
            return true;
        }
